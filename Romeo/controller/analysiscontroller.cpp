...
void AnalysisController::slotStartAnalysis()
{
    ...
    analysis= new Analysis(datasetObj, subjectsVector, featShow, featSave, exportFolder,-1, QDateTime(), this);
    AnalysisDAO daoA;
    lastCreateID = -1;
...
void AnalysisController::createDialogConnections()
{
    ...
    connect(analysis, &QThread::finished, analysis, &QThread::deleteLater);
